...
export function Dashboard() {
    const { metrics, analysisRun, loading, chartData, analysis, originalScript, cloudResources } = useThreatAnalysis();
                ...
                <Card className="md:col-span-2 lg:col-span-4 border-dashed bg-card shadow-none">
                    <CardContent className="p-6 flex flex-col items-center justify-center text-center gap-6 min-h-[400px]">
                        ...
                        <div className="max-w-xl">
                            <h2 className="text-2xl font-bold text-foreground tracking-tight">System Nominal. Awaiting Scenario.</h2>
                            <p className="text-muted-foreground mt-2 mb-6">
                                All sensors are online and the AI analysis engine is ready. Model an attack scenario to populate the dashboard with security events, metrics, and threat analysis.
                            </p>
                            <Button asChild size="lg" className="font-semibold">
                                <Link href="/powershell-simulator">
                                    <Terminal className="mr-2 h-5 w-5" />
                                    Go to Threat Sandbox
                                </Link>
                            </Button>
                        </div>
                    </CardContent>
                ...
                <Card className="md:col-span-2 lg:col-span-4">
                    <CardHeader className="flex flex-row justify-between items-start">
                        <div>
                            ...
                            <CardDescription>Generated by the NetGuard AI analysis engine.</CardDescription>
                        </div>
                    ...
                    <AlertDialogHeader>
                        ...
                        {isTestingDefense && (
                            <AlertDialogDescription>
                                The AI is modeling the engagement... please wait.
                            </AlertDialogDescription>
                        )}
                    ...
                    {isTestingDefense && (
                         <div className="flex-1 flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="font-semibold mt-4">Modeling Engagement</p>
                                ...
                                <div className="p-4 bg-muted/50 rounded-lg min-h-[148px] flex flex-col justify-center">
                                    {logAnimationComplete ? (
                                        ...
                                        <div className="text-center text-muted-foreground">
                                            <p className="text-sm">Waiting for live analysis to complete...</p>
                                        </div>
                                    )}
                                </div>
